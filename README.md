...
* https://github.com/dice-project/DICE-Simulation/raw/master/releng/setup/dice.simulation.configuration.latest.setup
* https://github.com/dice-project/DICE-Simulation/raw/master/releng/setup/dice.simulation.configuration.0.7.0.setup
...
In the running Eclipse instance, go to `Help -> Install New Software...` and use http://dice-project.github.io/DICE-Simulation/updates as the URL for the update site to install the latest versions.
...
The following is a list of the archived update sites af all current and previously released versions of the DICE Simulation Tool. Keep in mind that `0.x.x` versions are pre-releases.
