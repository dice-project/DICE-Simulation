 ...
 * </p>
 * <ul>
 *   <li>{@link configuration.impl.SimulationToolImpl#getProduces <em>Produces</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SimulationToolImpl extends MinimalEObjectImpl.Container implements SimulationTool {
	...
	protected EClass eStaticClass() {
		return ConfigurationPackage.Literals.SIMULATION_TOOL;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfigurationPackage.SIMULATION_TOOL__PRODUCES:
