...
/**
 * This is the item provider adapter for a {@link es.unizar.disco.simulation.models.measures.ResponseTime} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseTimeItemProvider extends DomainMeasureItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResponseTime_responseTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResponseTime_responseTime_feature", "_UI_ResponseTime_type"),
				 MeasuresPackage.Literals.RESPONSE_TIME__RESPONSE_TIME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Number labelValue = ((ResponseTime)object).getValue();
