...
public class InvocationAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected InvocationSwitch<Adapter> modelSwitch =
		new InvocationSwitch<Adapter>() {
			@Override
			public Adapter caseSimulationInvocation(SimulationInvocation object) {
			...
			@Override
			public Adapter caseInvocationSet(InvocationSet object) {
				return createInvocationSetAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.invocation.SimulationInvocation <em>Simulation Invocation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.invocation.InvocationSet <em>Set</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
