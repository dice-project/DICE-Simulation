 ...
 */
public class ActivityDiagram2PnmlReliabilityResourceBuilder extends AbstractPnmlResourceBuilder implements IAnalyzableModelBuilder {

	@Override
	protected URI getTransformationUri() {
		return URI.createURI(PnmlM2mPlugin.DPIM_AD2PNML_RELIABILITY_TRANSFORMATION_URI);
	}
}
