...
public class SimulationResultItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimulationResult_invocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimulationResult_invocation_feature", "_UI_SimulationResult_type"),
				 SimresultPackage.Literals.SIMULATION_RESULT__INVOCATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimresultPackage.Literals.SIMULATION_RESULT__MEASURES);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SimresultPackage.Literals.SIMULATION_RESULT__MEASURES,
				 MeasuresFactory.eINSTANCE.createDomainMeasure()));
	}
