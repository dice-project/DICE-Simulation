 ...
 * @generated
 */
public class ToolResultItemProvider 
	 ...
	 * @generated
	 */
	public ToolResultItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ToolResult_timestamp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ToolResult_timestamp_feature", "_UI_ToolResult_type"),
				 ToolresultPackage.Literals.TOOL_RESULT__TIMESTAMP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ToolresultPackage.Literals.TOOL_RESULT__INFOS);
		}
	...
	public String getText(Object object) {
		Date labelValue = ((ToolResult)object).getTimestamp();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ToolResult.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ToolresultPackage.Literals.TOOL_RESULT__INFOS,
				 WnsimFactory.eINSTANCE.createPlaceInfo()));

		newChildDescriptors.add
			(createChildParameter
				(ToolresultPackage.Literals.TOOL_RESULT__INFOS,
				 WnsimFactory.eINSTANCE.createTransitionInfo()));
	}
