...
public interface InvocationPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Analizable Resource</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SIMULATION_INVOCATION__ANALIZABLE_RESOURCE = 3;
	 ...
	 * @ordered
	 */
	int SIMULATION_INVOCATION__DEFINITION = 4;
	 ...
	 * @ordered
	 */
	int SIMULATION_INVOCATION__CALLS = 5;

	/**
	 * The feature id for the '<em><b>Calculates</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SIMULATION_INVOCATION__CALCULATES = 6;
	...
	/**
	 * Returns the meta object for the attribute '{@link es.unizar.disco.simulation.models.invocation.SimulationInvocation#getAnalizableResource <em>Analizable Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Analizable Resource</em>'.
	 * @see es.unizar.disco.simulation.models.invocation.SimulationInvocation#getAnalizableResource()
	 * @see #getSimulationInvocation()
	 * @generated
	 */
	EAttribute getSimulationInvocation_AnalizableResource();
	...
	/**
	 * Returns the meta object for the reference list '{@link es.unizar.disco.simulation.models.invocation.SimulationInvocation#getCalculates <em>Calculates</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Calculates</em>'.
	 * @see es.unizar.disco.simulation.models.invocation.SimulationInvocation#getCalculates()
	 * @see #getSimulationInvocation()
	 * @generated
	 */
	EReference getSimulationInvocation_Calculates();
	...
	/**
	 * Returns the meta object for the reference '{@link es.unizar.disco.simulation.models.invocation.VariableAssignment#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Analizable Resource</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute SIMULATION_INVOCATION__ANALIZABLE_RESOURCE = eINSTANCE.getSimulationInvocation_AnalizableResource();
		...
		/**
		 * The meta object literal for the '<em><b>Calculates</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SIMULATION_INVOCATION__CALCULATES = eINSTANCE.getSimulationInvocation_Calculates();
