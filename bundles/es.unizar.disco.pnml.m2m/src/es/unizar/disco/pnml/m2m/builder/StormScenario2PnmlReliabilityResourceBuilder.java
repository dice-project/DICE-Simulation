 ...
 */
public class StormScenario2PnmlReliabilityResourceBuilder extends AbstractPnmlResourceBuilder implements IAnalyzableModelBuilder {

	@Override
	protected URI getTransformationUri() {
		return URI.createURI(PnmlM2mPlugin.DTSM_STORM_AD2PNML_RELIABILITY_TRANSFORMATION_URI);
	}
}
