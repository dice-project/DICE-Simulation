/**
 */
package es.unizar.disco.simulation.models.invocation.util;
 ...
 * @generated
 */
public class InvocationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InvocationPackage.SIMULATION_INVOCATION: {
				SimulationInvocation simulationInvocation = (SimulationInvocation)theEObject;
				T result = caseSimulationInvocation(simulationInvocation);
			...
			case InvocationPackage.INVOCATION_SET: {
				InvocationSet invocationSet = (InvocationSet)theEObject;
				T result = caseInvocationSet(invocationSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simulation Invocation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simulation Invocation</em>'.
	 ...
	 * @generated
	 */
	public T caseInvocationSet(InvocationSet object) {
		return null;
	}
