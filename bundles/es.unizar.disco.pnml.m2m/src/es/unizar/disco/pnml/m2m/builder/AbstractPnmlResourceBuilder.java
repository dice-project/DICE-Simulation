...
public abstract class AbstractPnmlResourceBuilder implements IAnalyzableModelBuilder {
	...
	public ModelResult createAnalyzableModel(Element element, List<PrimitiveVariableAssignment> assignments) {
		TransformationExecutor executor = new TransformationExecutor(getTransformationUri());
