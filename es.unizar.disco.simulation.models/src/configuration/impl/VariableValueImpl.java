 ...
 * </p>
 * <ul>
 *   <li>{@link configuration.impl.VariableValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableValueImpl extends MinimalEObjectImpl.Container implements VariableValue {
	...
	protected EClass eStaticClass() {
		return ConfigurationPackage.Literals.VARIABLE_VALUE;
	}
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.VARIABLE_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConfigurationPackage.VARIABLE_VALUE__VALUE:
				return getValue();
		}
