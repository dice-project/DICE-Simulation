...
public class PnutilsAdapterFactory extends AdapterFactoryImpl {
	...
	protected PnutilsSwitch<Adapter> modelSwitch =
		new PnutilsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseToolInfoUtils(ToolInfoUtils object) {
				return createToolInfoUtilsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.pnextensions.pnutils.ToolInfoUtils <em>Tool Info Utils</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createToolInfoUtilsAdapter() {
		return null;
	}
