...
public class SimulationInvocationsRegistry {
	...
	private synchronized void resourcefyInvocation(SimulationInvocation invocation) {
		...
		final URI invURI = baseUri.appendSegment(invocation.getIdentifier()).appendFileExtension("inv").appendFileExtension(XMIResource.XMI_NS);
		final URI anmURI = baseUri.appendSegment(invocation.getIdentifier()).appendFileExtension("anm").appendFileExtension(XMIResource.XMI_NS);
		final URI trcURI = baseUri.appendSegment(invocation.getIdentifier()).appendFileExtension("trc").appendFileExtension(XMIResource.XMI_NS);
		final URI trsURI = baseUri.appendSegment(invocation.getIdentifier()).appendFileExtension("trs").appendFileExtension(XMIResource.XMI_NS);
		final URI resURI = baseUri.appendSegment(invocation.getIdentifier()).appendFileExtension("res").appendFileExtension(XMIResource.XMI_NS);
