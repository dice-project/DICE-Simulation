...
public class PerformanceHadoopTest extends AbstractTest {
	...
	public void testLoadProfiledModel() throws IOException {
		...
		assertTrue("The HadoopComputationNode stereotype does not contain information about number of cores ",
				(computNode.getValue(computNode.getAppliedStereotype("DICE::DICE_UML_Extensions::DTSM::Hadoop::HadoopComputationNode"), "nCores")!=null));
	}
	...
	private DomainMeasure calculateResults(SimulationInvocation invocation, String chosenMeasure) {
		...
		ActivityResponseTimeCalculatorHadoop calculator = new ActivityResponseTimeCalculatorHadoop();
