 ...
 * </p>
 * <ul>
 *   <li>{@link es.unizar.disco.simulation.models.traces.impl.TraceSetImpl#getTraces <em>Traces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TraceSetImpl extends MinimalEObjectImpl.Container implements TraceSet {
	/**
	...
	protected EClass eStaticClass() {
		return TracesPackage.Literals.TRACE_SET;
	}
	...
	public EList<Trace> getTraces() {
		if (traces == null) {
			traces = new EObjectContainmentEList<Trace>(Trace.class, this, TracesPackage.TRACE_SET__TRACES);
		}
		return traces;
	}
