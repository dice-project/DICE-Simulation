/**
 */
package es.unizar.disco.simulation.models.definition.util;
...
public class DefinitionAdapterFactory extends AdapterFactoryImpl {
	...
	protected DefinitionSwitch<Adapter> modelSwitch =
		new DefinitionSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSimulationParameter(Map.Entry<String, String> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.definition.SimulationDefinition <em>Simulation Definition</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Simulation Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.definition.Variable <em>Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.definition.InputVariable <em>Input Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.definition.OutputVariable <em>Output Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.unizar.disco.simulation.models.definition.InputVariableValue <em>Input Variable Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
