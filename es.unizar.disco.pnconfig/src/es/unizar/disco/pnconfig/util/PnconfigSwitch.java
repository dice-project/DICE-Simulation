 ...
 * @generated
 */
public class PnconfigSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PnconfigPackage.PETRI_NET_CONFIG: {
				PetriNetConfig petriNetConfig = (PetriNetConfig)theEObject;
				T result = casePetriNetConfig(petriNetConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PnconfigPackage.ESTRING_TO_EFLOAT_OBJECTS_MAP: {
	 ...
	 * @generated
	 */
	public T casePetriNetConfig(PetriNetConfig object) {
		return null;
	}
